...
func (e statusErr) IsPreOutputStreamFailure() bool { return e.streamFailure }

func (e statusErr) UpstreamStatusCode() int {
	if e.upstreamStatus != 0 {
		return e.upstreamStatus
	}
	return e.code
}
func (e statusErr) UpstreamResponseBody() []byte {
