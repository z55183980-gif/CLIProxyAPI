...
func (s *Server) setupRoutes() {
	...
	// Serve split management center assets alongside the HTML shell.
	s.engine.Static("/management-assets", managementasset.StaticDir(s.configFilePath)+string(filepath.Separator)+"assets")
	s.engine.Static("/assets", managementasset.StaticDir(s.configFilePath)+string(filepath.Separator)+"assets")
